...
public class studentcourses extends JPanel{
    ...
    public studentcourses(String year ,String time) {
        try {
        ...
        img.setIcon(new ImageIcon("lec stud.png"));
        
        /////////////////////////////////////////
        String []colom={"name","lecturer","lec-num","duration","mark","term","year"};
        Object [][]data={};
        ...
        scrollPane.setBounds(28, 40, 990, 640);
        ///////////////////////////////////////////////
    ...
    private void lod1(String year){
        ...
        try {
            ...
            String strse="SELECT * FROM oo.course where year='"+year+"' and term='1th' ;";
            ...
            JOptionPane.showMessageDialog(null, 
                              "sorry we can not get your courses now", 
                              "error", 
    ...
    private void lod2(String year){
        ...
        try {
            Statement statm=c.createStatement();
            String strse="SELECT * FROM oo.course where year='"+year+"' and term='2th' ;";
            ResultSet set=statm.executeQuery(strse);
            while(set.next()){
                for(int i=0;i<7;i++){
                    arr[i]=set.getString(i+1);
